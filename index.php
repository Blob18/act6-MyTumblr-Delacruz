...
http://localhost/MyTumblr/index.php = "catherine";
$acc_username = "catherine";
$acc_password = "cathy.123";
$acc_fullname = "Catherine Dela Cruz";
$acc_address = "Santa Cruz Marinduque";
...
if (isset($_REQUEST['login_button']) === true){
	//get the username and password from the form and compare to the predefined user and password
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist']) === true){
		      					echo "<div class='alert alert-danger' role='alert'> Username does not exist please try again...</div>";
		      			
		      			} else if (isset($_REQUEST['wrongpass']) === true){
		      					echo "<div class='alert alert-warning' role='alert'> Access Denied...</div>";

		      			}else if (isset($_REQUEST['success']) === true){
		      						echo "<div class='alert alert-sucess' role='alert'> Authenticating Please Wait... </div>";
		      				...
		      				echo "<div class='alert alert-info' role='alert'> Sign In First... </div>";
